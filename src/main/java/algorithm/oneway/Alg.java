...
public class Alg {
    ...
    public void startOptimization(String str) throws Exception {
        ...
        PriorityQueue<QuantumEvent> eventTrace = rt.readSerListFromText(str);
        QuantumEvent event;
        double ent = 0;
...
//        abs.startOptimization();
        ...
        for(int i = 100; i < 200 ; i+=20){
            String str = "src/main/java/service/business/NSFNET/v04-5/Service_" + i + "_5_3.txt";
            System.out.println(i+":");
            System.out.println("------------优化后------------");
            Alg oar = new Alg();
            oar.startOptimization(str);

            System.out.println("-----------KeyEngineering-----------");
            AlgKE lll = new AlgKE();
            lll.startOptimization(str);
        }
    }
}
